...
GoogleSpeechApi.prototype.requestGoogle = function (callback) {
    var self = this;
    exec("curl -X POST --data-binary @'tmp/file.wav' --header 'Content-Type: audio/l16; rate=16000;' 'https://www.google.com/speech-api/v2/recognize?output=json&lang=fr-fr&key=AIzaSyCsTgfvpYJl0hNgeaygcF6IYOXn41i0H9w'", function (error, stdout, stderr) {
